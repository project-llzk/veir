...
// half. When `a = b` it is a left rotate. Poison on any operand propagates.
"builtin.module"() ({
  "func.func"() <{sym_name = "main", function_type = () -> (i32, i32, i32, i32, i32, i32)}> ({
    ...
    // Shift amount of 0 returns `a` unchanged.
    %r2 = "llvm.intr.fshl"(%a, %b, %c0) : (i32, i32, i32) -> i32
    // Shift amount is taken modulo the bit width: 40 == 8.
    %r3 = "llvm.intr.fshl"(%a, %b, %c40) : (i32, i32, i32) -> i32
    // `a = b` is a left rotate by 4.
    %r4 = "llvm.intr.fshl"(%x, %x, %c4) : (i32, i32, i32) -> i32
    // Poison on any operand propagates.
    %r5 = "llvm.intr.fshl"(%p32, %b, %c8) : (i32, i32, i32) -> i32
    %r6 = "llvm.intr.fshl"(%a, %b, %p32) : (i32, i32, i32) -> i32
...
// CHECK: Program output: #[0x3456789a#32, 0x12345678#32, 0x3456789a#32, 0x0000001f#32, poison, poison]
