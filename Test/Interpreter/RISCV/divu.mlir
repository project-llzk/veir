...
"builtin.module"() ({
  "func.func"() <{sym_name = "main", function_type = () -> (!riscv.reg, !riscv.reg, !riscv.reg)}> ({
    ...
    %d = "riscv.li"() <{ value = 4294967296 : i64 }> : () -> !riscv.reg
    %e = "riscv.li"() <{ value = 3 : i64 }> : () -> !riscv.reg
    %f = "riscv.divu"(%a, %b) : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %g = "riscv.divu"(%a, %c) : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %h = "riscv.divu"(%d, %e) : (!riscv.reg, !riscv.reg) -> !riscv.reg
