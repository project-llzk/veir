...
"builtin.module"() ({
  "func.func"() <{sym_name = "main", function_type = () -> !riscv.reg}> ({
    ...
    "riscv.sd"(%a, %x8) <{ "value" = 0 : i64 }> : (!riscv.reg, !riscv.reg) -> ()
    "riscv.sw"(%a, %x4) <{ "value" = 4 : i64 }> : (!riscv.reg, !riscv.reg) -> ()
    "riscv.sh"(%a, %x2) <{ "value" = 6 : i64 }> : (!riscv.reg, !riscv.reg) -> ()
    "riscv.sb"(%a, %x1) <{ "value" = 7 : i64 }> : (!riscv.reg, !riscv.reg) -> ()
